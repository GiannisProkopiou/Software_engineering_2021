...
--
-- Host: localhost    Database: track_and_deliver_db
-- ------------------------------------------------------
...
CREATE TABLE `delivers` (
  `delivery_man_afm` int(11) DEFAULT NULL,
  `shipment_number` int(11) NOT NULL,
  `state` enum('in_tansit','delivered','pending') DEFAULT NULL,
...
INSERT INTO `delivers` VALUES (2,5,'pending','2021-06-10'),(2,45643,'pending','2021-06-10'),(NULL,123456,'pending','2021-06-10');
...
INSERT INTO `delivery_man` VALUES (1,1,'test','test1','123456789','test@gmail.com','available','+306912345678'),(2,1,'Kontarinis','Apostolos','123456789','tolis@gmail.com','available','+3012345678');
...
CREATE TABLE `package` (
  ...
  `delivery_attempts` int(11) NOT NULL,
...
INSERT INTO `package` VALUES (1,'2021-06-10',1,'2021-06-10',953,'GENIKI','30x40x100',2,'in_transit','sina@gmail.com','2021-09-03',NULL),(2,'2021-06-25',0,'2021-06-10',354,'GENIKI','30x40x100',9,'in_transit','sina@gmail.com','2021-06-10',NULL),(3,'2021-06-02',1,'2021-06-10',32,'SPEEDEX','30x40x100',7,'delivered','sina@gmail.com','2021-06-10',NULL),(4,'2021-06-25',0,'2021-06-10',529,'GENIKI','30x40x100',2,'delivered','sina@gmail.com','2021-06-10',NULL),(5,'2021-06-21',1,'2021-06-10',915,'ACS','30x40x100',5,'in_transit','sina@gmail.com','2021-06-10',NULL),(6,'2021-06-30',1,'2021-06-10',735,'ACS','30x40x100',8,'delivered','sina@gmail.com','2021-06-10',NULL),(45643,'2021-09-03',0,'2021-09-03',446,'ACS','30x40x100',4,'on_hold','sina@gmail.com','2021-09-03',NULL),(123456,'2021-09-03',1,'2021-06-10',943,'ACS','30x40x100',0,'in_transit','sina@gmail.com','2021-09-03',NULL),(290199,'2021-09-03',1,'2021-09-03',975,'ACS','30x40x100',3,'delivered','sina@gmail.com','2021-09-03',NULL),(434233,'2021-07-06',0,'2021-06-10',259,'SPEEDEX','30x40x100',4,'in_transit','sina@gmail.com','2021-06-10',NULL),(656565,'2021-09-03',1,'2021-09-03',103,'GENIKI','30x40x100',6,'in_transit','sina@gmail.com','2021-09-03',NULL),(11111111,'2021-07-05',0,'2021-06-10',394,'ACS','30x40x100',7,'delivered','sina@gmail.com','2021-06-10',NULL),(43214321,'2021-09-03',0,'2021-09-03',781,'DHL','30x40x100',5,'in_transit','sina@gmail.com','2021-09-03',NULL),(121233434,'2021-06-16',1,'2021-06-10',729,'ELTA COURIER','30x40x100',4,'on_hold','sina@gmail.com','2021-06-10',NULL),(454523542,'2021-09-03',1,'2021-09-03',956,'ELTA COURIER','30x40x100',5,'in_transit','sina@gmail.com','2021-09-03',NULL);
...
--
-- Dumping events for database 'track_and_deliver_db'
--
...
-- Dump completed on 2021-06-11 22:31:17
